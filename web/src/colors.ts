...
export function getLutColor(theta: number, omegaSq: number, out: Uint8Array | Uint8ClampedArray, offset: number) {
    ...
    const eIdx = Math.min(ENG_STEPS - 1, Math.floor((omegaSq / 10.0) * ENG_STEPS));
