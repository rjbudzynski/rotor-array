...
def test_verlet_energy_conservation_numba():
    """Verify that Velocity Verlet conserves energy with numba acceleration."""
...
def test_verlet_field_energy_conservation_numba():
    """Verify energy conservation with non-zero field M using numba."""
    from simulation import NUMBA_AVAILABLE
